...
public class behavioural_followup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_behavioural_followup);

        YesQuestions = getResources().getStringArray(R.array.CMH_FolowUp_Yes);
        NoQuestions = getResources().getStringArray(R.array.CMH_FolowUp_No);
        ...
        othbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (othbtn.getText().toString().equalsIgnoreCase("Home")) {
                    Intent intent = new Intent(behavioural_followup.this, HomeActivity.class);
